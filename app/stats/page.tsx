...
export default function Home() {
    ...
    return(
        ...
        <div className='p-2'>{`Total Profit: ${playerStats.totalProfit}`}</div>
        <div className='p-2'>{`Average Profit: ${playerStats.avgProfit}`}</div>
        <div className='p-2'>{`Number of Sessions: ${playerStats.numSessions}`}</div>
        <div className='p-2'>{`Standard Deviation: ${playerStats.stdDev}`}</div>
        <div className='p-2'>{`Win Rate: ${playerStats.winRate}`}</div>
        <div className='p-2'>{`Max Profit: ${playerStats.maxProfit}`}</div>
        <div className='p-2'>{`Max Loss: ${playerStats.maxLoss}`}</div>
